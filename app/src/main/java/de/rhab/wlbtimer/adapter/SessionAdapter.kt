...
class SessionAdapter(options: FirestoreRecyclerOptions<Session>)
    ...
    fun deleteItem(position: Int) {
        ...
        // ToDo(frennkie) also need to remove Session from Category!
    }

    inner class SessionHolder(itemView: View) :
        RecyclerView.ViewHolder(itemView) {

        val mCard: androidx.cardview.widget.CardView =
            itemView.findViewById<View>(R.id.card_session) as androidx.cardview.widget.CardView
        ...
        val mTsStartView: TextView =
            itemView.findViewById<View>(R.id.tv_session_ts_start) as TextView
        val mTsEndView: TextView = itemView.findViewById<View>(R.id.tv_session_ts_end) as TextView
        val mTsDurationView: TextView =
            itemView.findViewById<View>(R.id.tv_session_duration) as TextView
